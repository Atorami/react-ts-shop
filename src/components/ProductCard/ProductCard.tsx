...
export const ProductCard: FC<Product> = ({ img_path, title, descr, price }) => {
  return (
    <div className="product__card w-[270px] flex flex-col justify-center text-center shadow-md hover:shadow-2xl transition ease-out hover:scale-105 duration-1000 ">
